...
[many smaller projects](https://symbiflow.github.io/#subprojects) (and as our list of supported platforms grows, that's not even the full list), there's plenty to choose from if you're looking for helping some ambitious projects in need of better documentation.
...
talk to us further about them. A technical writer will not be able to succeed if
they don't understand the subject matter at least some significant extent, and
talking to us is the best way of learning what SymbiFlow is about and how it works. 
...
[dedicated label on a separate issue tracker](https://github.com/SymbiFlow/ideas/issues?q=is%3Aopen+is%3Aissue+label%3Atype-docs)
which contains tasks which are suitable to be completed as part of GSoD.

## Can I work on XXX?

If a idea has the [project-docs label](#project-docs-label) on our Ideas issue tracker, it's probably
a good one!

## What should I work on?

What do you like to do? What interests you? You might know better what projects are
going to keep you interested than we do - and if you need to know more about SymbiFlow to figure it our, come talk to us on IRC.

## Is project XXX important?

**For GSoD the most important factor is the application quality!** If the
...
While Google Season of Docs is a new program, 
...
During Season of Docs many new people turn up, keeping you all straight
...
### **Tip 6** - Splitting applications which are too big

Google limits the text you can submit for your detailed description characters.
This can be quite limited if you have some detailed information.
...
the very important bits of your application. There should be enough meat in this section to
convince us to look at your further URL.

The URL in the document should link to your full proposal. Feel free to add
anything which you feel is relevant.
...
Google Season of Docs will require you to work independently and hence showing
...
Often the best way to ask questions is to start writing your Google Season of Docs proposal as documented in the [Writing Proposals](#writing-proposals) section and find out what areas you are getting stuck at.
...
For GSoD the most important factor is the application quality! If the strongest
